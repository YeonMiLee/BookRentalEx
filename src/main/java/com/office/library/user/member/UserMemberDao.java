...
public class UserMemberDao {
	...
	public int insertUserAccount(UserMemberVo userMemberVo) {
		...
		String sql = "INSERT INTO tbl_user_member (u_m_id, " + "u_m_pw, " + "u_m_name, " 
								+ "u_m_gender, " + "u_m_mail, " + "u_m_phone, " + "u_m_reg_date, "
	...
	public int updateUserAccount(UserMemberVo userMemberVo) {
		...
		String sql = "UPDATE tbl_user_member SET " + "u_m_name = ?, " + "u_m_gender = ?, "
					+ "u_m_mail = ?, " + "u_m_phone = ?, " + "u_m_mod_date = NOW() "
					+ "WHERE u_m_no = ?";
		int result = -1;
	...
	public int updatePassword(String u_m_id, String newPassword) {
		...
		String sql = "UPDATE tbl_user_member SET " + "u_m_pw = ?, u_m_mod_date = NOW() "
					+ "WHERE u_m_id = ?";
		int result = -1;
